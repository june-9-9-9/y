...
• {members} - Shows total members in the group`,
    ...
    switch (command.toLowerCase()) {
        case 'on':
            ...
            await addWelcome(chatId, true, 'Welcome {user} to {group}! 🎉 I am {bot}, here to assist.');
...
🔹 {members} - Shows total members in the group`,
    ...
    switch (command.toLowerCase()) {
        case 'on':
            ...
            await addGoodbye(chatId, true, 'Goodbye {user} from {group}! 👋 Regards, {bot}.');
