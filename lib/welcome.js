...
const settingsFile = path.join(__dirname, 'welcomeGoodbye.json');
...
module.exports = { handleWelcome, handleGoodbye, addWelcome, delWelcome, isWelcomeOn, addGoodbye, delGoodBye, isGoodByeOn };
